      ...
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
          ...
          <div className="flex items-center justify-center">
            <div className="relative w-full max-w-[500px] h-[400px] bg-gradient-to-br from-primary/20 to-muted rounded-xl overflow-hidden shadow-lg">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-background/80 backdrop-blur-sm p-4">
                <p className="text-sm font-medium text-center">Multimodal learning with text, images, and voice</p>
              </div>
            </div>
          </div>
        </div>
