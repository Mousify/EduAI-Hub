    ...
    <div className="container mx-auto py-12 px-4 md:px-6">
      <div className="space-y-4 text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Empower your entire school with our comprehensive AI tutoring platform
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
        <div>
          ...
          <p className="text-lg mb-6">
            Our platform is designed to support schools at every level, from individual classrooms to district-wide
            implementations. We offer special pricing and features for educational institutions.
          </p>
        ...
        <div className="rounded-lg overflow-hidden shadow-xl">
          <img src="/placeholder.svg?height=400&width=600" alt="School implementation" className="w-full h-auto" />
        </div>
      </div>

      <div className="bg-muted rounded-lg p-8 mb-16">
        <h2 className="text-3xl font-bold mb-6 text-center">How Schools Benefit</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-card p-6 rounded-lg shadow">
            <h3 className="text-xl font-bold mb-3">Improved Outcomes</h3>
            <p>
              Students receive personalized support that leads to better academic performance and increased confidence.
            </p>
          </div>
          <div className="bg-card p-6 rounded-lg shadow">
            <h3 className="text-xl font-bold mb-3">Teacher Support</h3>
            <p>
              Teachers gain powerful tools to create content, assess student understanding, and identify learning gaps.
            </p>
          </div>
          <div className="bg-card p-6 rounded-lg shadow">
            <h3 className="text-xl font-bold mb-3">Equitable Access</h3>
            <p>Every student gets access to high-quality tutoring support regardless of socioeconomic background.</p>
          </div>
        </div>
      </div>

      <div className="mb-16">
        <h2 className="text-3xl font-bold mb-8 text-center">Pricing for Schools</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div className="bg-card rounded-lg p-8 shadow-lg">
        ...
        <p className="text-center mb-8 max-w-2xl mx-auto">
          See how our platform can benefit your school or district. Schedule a personalized demo with our education
          specialists.
        </p>
        <form className="max-w-xl mx-auto grid gap-4">
          ...
          <div>
            ...
            <input type="text" id="school" className="w-full p-2 border rounded" />
          </div>
          <div>
