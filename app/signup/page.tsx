          ...
          <div className="mx-auto max-w-sm">
            ...
            >
              <TabsList className="grid w-full grid-cols-2 bg-gray-800">
                <TabsTrigger value="student" className="data-[state=active]:bg-gray-700 text-white">
                  Student
                </TabsTrigger>
                <TabsTrigger value="teacher" className="data-[state=active]:bg-gray-700 text-white">
                  Teacher
                </TabsTrigger>
              </TabsList>
            ...
            {(error || formError) && (
              <div className="mb-4 rounded-lg bg-red-900/50 p-3 text-sm text-red-200">{error || formError}</div>
            )}

            <div className="mb-8">
              <Button
                variant="outline"
                className="w-full h-12 border-gray-800 bg-gray-900 text-white hover:bg-gray-800"
