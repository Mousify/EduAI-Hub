      ...
      <div className="container mx-auto py-12 px-4 md:px-6">
        <div className="space-y-4 text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Join us for live demonstrations, educational workshops, and
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-6 flex flex-col justify-center">
                ...
                <CardTitle className="text-3xl mb-4">
                  AI in Education Summit: The Future of Learning
                </CardTitle>
                <CardDescription className="text-base mb-6">
                  Join leading educators and AI experts for a comprehensive
                  exploration of how artificial intelligence is transforming
                ...
                {Array.from({ length: 35 }).map((_, i) => {
                  ...
                  return (
                    ...
                    >
                      {day > 0 && day <= 30 ? day : ""}
                      {day === 10 && (
                        <div className="mt-1 text-xs p-1 bg-blue-100 text-blue-800 rounded">
                          Webinar: AI Basics
                        </div>
                      )}
                      {day === 15 && (
                        <div className="mt-1 text-xs p-1 bg-red-100 text-red-800 rounded">
                          Summit
                        </div>
                      )}
                      {day === 22 && (
                        <div className="mt-1 text-xs p-1 bg-green-100 text-green-800 rounded">
                          Workshop
                        </div>
                      )}
                    </div>
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            If you&apos;re an educator or institution interested in hosting a
            webinar or workshop on our platform, we&apos;d love to hear from
            you.
          </p>
