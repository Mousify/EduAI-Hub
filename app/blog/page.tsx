    ...
    <div className="container mx-auto py-12 px-4 md:px-6">
      <div className="space-y-4 text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Insights, updates, and resources on AI in education, learning strategies, and platform features
        </p>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 flex flex-col justify-center">
              ...
              <CardTitle className="text-3xl mb-4">
                The AI Tutoring Revolution: How Personalized Learning is Changing Education
              </CardTitle>
              <CardDescription className="text-base mb-6">
                Explore how AI-powered tutoring is transforming the educational landscape by providing personalized
      ...
      <div className="flex flex-wrap gap-2 justify-center mb-12">
        <Badge variant="outline" className="text-sm py-1 px-3 cursor-pointer hover:bg-secondary">
          All
        </Badge>
        <Badge variant="outline" className="text-sm py-1 px-3 cursor-pointer hover:bg-secondary">
          AI in Education
        ...
        <CardContent className="flex flex-col md:flex-row items-center justify-between gap-6 py-8">
          <div className="space-y-2 text-center md:text-left">
            ...
            <p className="text-muted-foreground">
              Get the latest articles, updates, and resources delivered to your inbox.
            </p>
          </div>
