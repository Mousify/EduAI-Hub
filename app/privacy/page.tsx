  ...
  <div className="flex min-h-screen flex-col">
    ...
    <div className="container mx-auto py-12 px-4 md:px-6">
      <div className="space-y-4 text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Last updated: April 29, 2024</p>
      </div>

      <div className="prose prose-lg dark:prose-invert mx-auto">
        <h2>1. Introduction</h2>
        <p>
          Welcome to AI Tutoring & Classroom Hub. We respect your privacy and are committed to protecting your personal
        ...
        <ul>
          <li>
            <strong>Identity Data</strong> includes first name, last name, username or similar identifier, and date of
            birth.
          </li>
          <li>
          ...
          <li>
            <strong>Educational Data</strong> includes information about your educational activities, progress, and
            performance.
          </li>
        </ul>
        ...
        <p>
          Email: privacy@aitutoringhub.com
          <br />
