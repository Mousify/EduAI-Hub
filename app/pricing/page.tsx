          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center text-center space-y-4 mb-12">
              ...
              <p className="max-w-[700px] text-muted-foreground md:text-xl">
                Choose the plan that's right for you, with flexible options for
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
              ...
              <Card className="flex flex-col border-purple-100">
                <CardHeader>
                  ...
                  <CardDescription className="mt-4">
                    Powerful tools to enhance your teaching.
                  </CardDescription>
                </CardHeader>
                <CardContent className="flex-1">
                  <ul className="space-y-3">
            ...
            <div className="mt-16">
              <div className="flex flex-col items-center text-center space-y-4 mb-12">
                ...
                <p className="max-w-[700px] text-muted-foreground">
                  Custom solutions for educational institutions with volume
                  discounts and administrative features.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                ...
                <Card className="flex flex-col">
                  <CardHeader>
                    ...
                    <CardDescription className="mt-4">
                      For individual schools looking to provide AI learning
                      tools to their students and teachers.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="flex-1">
                    <ul className="space-y-3">
                      <PricingItem included>
                        Bulk licensing for students & teachers
                      </PricingItem>
                      <PricingItem included>
                ...
                <Card className="flex flex-col">
                  <CardHeader>
                    ...
                    <CardDescription className="mt-4">
                      For school districts seeking a comprehensive solution
            ...
            <div className="mt-16">
              <div className="flex flex-col items-center text-center space-y-4 mb-12">
                ...
                <p className="max-w-[700px] text-muted-foreground">
                  Need more AI power? Purchase additional tokens for your
                  account.
                </p>
              </div>
              ...
              <div className="mx-auto max-w-3xl">
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                      AI tokens are the currency used to access our AI-powered
                      features. Each AI interaction (like generating a study
                      guide or getting homework help) consumes a certain number
                      of tokens depending on the complexity and length of the
                      task. Your subscription includes a monthly allocation of
                  ...
                  <AccordionItem value="item-3">
                    ...
                    <AccordionContent>
                      No, unused tokens do not roll over to the next month. Your
                      token allocation resets at the beginning of each billing
                      cycle. This helps us maintain the quality and availability
                      of our AI services for all users.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-4">
                    ...
                    <AccordionContent>
                      ...
                      The exact discount depends on the number of users and
                      specific requirements. Please contact our sales team for a
                      customized quote.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-5">
                    ...
                    <AccordionContent>
                      Our Free plan allows you to try out the platform with a
                      limited number of tokens. This gives you a chance to
                      experience our AI tools before committing to a paid
                      subscription.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-6">
                    ...
                    <AccordionContent>
                      ...
                      account settings. After cancellation, you'll continue to
                      have access to your plan until the end of your current
                      billing cycle. We don't offer refunds for partial months.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </div>
