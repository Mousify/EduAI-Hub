export const metadata = {
  title: "Cookie Policy | AI Tutoring & Classroom Hub",
  description: "Learn about how we use cookies on our AI-powered tutoring platform.",
}
  ...
  return (
    <div className="container mx-auto py-12 px-4 md:px-6 max-w-4xl">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground">Last updated: May 8, 2023</p>
      </div>

      <div className="prose prose-slate dark:prose-invert max-w-none">
        <h2>1. Introduction</h2>
        <p>
          This Cookie Policy explains how AI Tutoring & Classroom Hub ("we", "us", or "our") uses cookies and similar
          technologies to recognize you when you visit our website. It explains what these technologies are and why we
        ...
        <p>
          Cookies set by the website owner (in this case, AI Tutoring & Classroom Hub) are called "first-party cookies".
